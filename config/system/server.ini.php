...
return [
    ...
    'TCP' => [
        ...
        'secret_key' => 'qgwXk3vqlVxIv63i' //加密秘钥
    ],
    //swoole原生配置
    'SWOOLE' => [
        ...
        'open_http2_protocol' => true, //启用HTTP2协议解析，需要依赖--enable-http2编译选项
...
//        'static_handler_locations' => ['/web']
    ...
    'WEBSOCKET' => [
        ...
        'max_connections' => 12, //最大连接数 2的10次方(1024)
        'heartbeat_idle_time' => 600, //一个连接如果600秒内未向服务器发送任何数据，此连接将被强制关闭
        'heartbeat_check_interval' => 60, //表示每60秒遍历一次
        'heartbeat' => 2, //心跳类型：1-自动PING(PONG)心跳 2-手动心跳 0-关闭心跳
